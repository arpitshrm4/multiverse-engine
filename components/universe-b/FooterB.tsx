        ...
        <footer className="py-12 px-6 md:px-16 border-t border-slate-800/80 bg-slate-950 font-sans">
            <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row justify-between items-start text-sm text-slate-400">
                ...
                <div className="flex gap-6 mt-4 md:mt-0">
                    ...
                    <a href="https://docs.google.com/document/d/1Ye0Q6Os6GxTXECnGlFYQHJtfMsk7dJewBCPUD0eyi24/edit?usp=sharing" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Resume</a>
                </div>
            </div>
        </footer>
    );
