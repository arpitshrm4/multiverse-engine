        ...
        <footer className="py-12 border-t border-[var(--divider-color)] bg-[var(--bg-primary)]">
            <div className="container flex flex-col md:flex-row justify-between items-start text-sm text-[var(--text-secondary)]">
                ...
                <div className="flex gap-6 mt-4 md:mt-0">
                    ...
                    <a href="https://docs.google.com/document/d/1Ye0Q6Os6GxTXECnGlFYQHJtfMsk7dJewBCPUD0eyi24/edit?usp=sharing" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--text-primary)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ffb000] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a0a] rounded-sm">Resume</a>
                </div>
            </div>
        </footer>
    );
