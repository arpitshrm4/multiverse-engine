...
// This is a client component for now to keep things simple with our static data
// In a real 'dynamic route' scenario with generateStaticParams this would be cleaner
